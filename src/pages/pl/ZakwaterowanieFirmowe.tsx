          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              ...
              <div className="text-center md:text-left">
                <p className="text-lg font-semibold text-nordic-900">Kajsa i Nathalie</p>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="w-14 h-14 bg-nordic-200 rounded-full overflow-hidden">
                  <img src="/images/mats-testimonial.jpg" alt="Klient" className="w-full h-full object-cover" />
                </div>
