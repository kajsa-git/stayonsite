...
const PersonalboendGuide2026 = () => {
  ...
  return (
    <BlogLayout post={post}>
      ...
      <ul>
        <li>
          <strong><Link to="/stad/lulea">Luleå</Link></strong> &mdash; Datacenter (Microsoft,
          Meta), Luleå tekniska universitet. Extremt tight bostadsmarknad.
        </li>
        <li>
          <strong><Link to="/stad/boden">Boden</Link></strong> &mdash; H2 Green Steel, HYBRIT
      ...
      <ul>
        <li>
          <strong><Link to="/stad/stockholm">Stockholm</Link></strong> &mdash; Tunnelbaneutbyggnad
          (Gula linjen), Nya Slussen, sjukhusrenoveringar. Enormt behov men extrem brist.
        </li>
        <li>
          <strong><Link to="/stad/goteborg">Göteborg</Link></strong> &mdash; Västlänken, Hisingsleden,
          Volvo-fabrikerna. Stor efterfrågan på västkusten.
        </li>
        <li>
          <strong><Link to="/stad/malmo">Malmö</Link></strong> &mdash; Öresundsregionens
      ...
      <ul>
        <li>
          <strong><Link to="/stad/umea">Umeå</Link></strong> &mdash; Universitetsstaden med
          stor tillväxt och sjukhusutbyggnad.
        </li>
        <li>
          <strong><Link to="/stad/ostersund">Östersund</Link></strong> &mdash;
      ...
      <p>
        ...
        <Link to="/blogg/gron-omstallning-norr-boende">
      ...
      <p>
        ...
        <Link to="/for-husagare">sida för husägare</Link>.
      </p>
      ...
      <p>
        <strong>
          Behöver ditt företag personalboende? <Link to="/for-foretag">Skicka en
