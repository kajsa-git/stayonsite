      ...
      <main className="flex-grow">
        ...
        <section className="bg-primary text-white pt-32 pb-16">
          <div className="container mx-auto px-6 md:px-12 max-w-4xl">
            <Link to="/blogg" className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm mb-8 transition-colors">
              <ArrowLeft size={16} />
        ...
        <section className="py-16 bg-nordic-50 border-t border-nordic-100">
          <div className="container mx-auto px-6 md:px-12 text-center max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to={language === 'sv' ? '/for-husagare' : '/for-husagare'} className="inline-flex items-center justify-center gap-2 bg-white text-nordic-900 px-8 py-4 rounded-full font-bold border border-nordic-200 hover:border-accent transition-colors">
