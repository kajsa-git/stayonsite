...
// Stämplade affärsvillkor per match: SendOfferDialog — erbjudandet till kund
// (offer_*). Stämplas när det skickas; objektets rentOut kan ändras efteråt utan
// att röra affären. Kundens erbjudandelänk visar ENDAST offer_*-fälten.
// Uthyrarens villkor (promised_*) fylls i vid det skarpa kontraktet — löftes-
// steget togs bort ur matchflödet 2026-07-13 (Kajsas beslut); kolumnerna och
// händelseloggen behålls som kontraktets underlag.
