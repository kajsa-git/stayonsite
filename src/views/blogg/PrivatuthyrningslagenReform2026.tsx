...
const PrivatuthyrningslagenReform2026 = () => {
  ...
  return (
    <BlogLayout post={post}>
      ...
      <p>
        I städer som <Link href="/stad/lulea">Luleå</Link>, <Link href="/stad/boden">Boden</Link>,{' '}
        <Link href="/stad/skelleftea">Skellefteå</Link> och <Link href="/stad/kiruna">Kiruna</Link> är
      ...
      <p>
        Läs även vår <Link href="/blogg/personalboende-guide-2026">kompletta guide till
        personalboende 2026</Link> och vår analys av{' '}
        <Link href="/blogg/gron-omstallning-norr-boende">den gröna omställningens
        boendeeffekter</Link>.
      </p>
    </BlogLayout>
  );
