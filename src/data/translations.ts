...
export const translations: Record<AvailableLanguages, Record<TranslationKey, string>> = {
  ...
  pl: {
    ...
    'services.process.step1.description': 'Wypełnij nasz prosty formularz ze szczegółami dotyczącymi Twoich potrzeb',
    'services.process.step2.title': 'Szybka odpowiedź',
    'services.process.step2.description': 'Odpowiadamy szybko przez e-mail lub SMS z opcjami',
    'services.process.step3.title': 'Potwierdzenie',
    'services.process.step3.description': 'Wybierz opcję, która Ci najbardziej odpowiada, a my ją dla Ciebie zarezerwujemy',
    'services.process.step4.title': 'Wprowadzenie',
    'services.process.step4.description': 'Twoi pracownicy otrzymują wszystkie informacje potrzebne do płynnej przeprowadzki',
    'services.security.title': 'Bezpieczeństwo dzięki doświadczonemu partnerowi',
    'services.security.description': 'Mając ponad 10-letnie doświadczenie w pomaganiu firmom budowlanym w zakwaterowaniu, możesz zaufać, że StayOnSite dostarcza zakwaterowanie spełniające Twoje potrzeby, na czas i zgodnie z ustaleniami. Posiadamy szeroką sieć opcji mieszkaniowych w całej Szwecji.',
    ...
    'services.whyus.point3': 'Płynny proces od początku do końca',
    ...
    'faq.subtitle': 'Tutaj znajdziesz odpowiedzi na najczęstsze pytania dotyczące naszych usług i zakwaterowania personelu.',
    'faq.tagline': 'FAQ',
    'faq.question1': 'Jak szybko możecie zorganizować zakwaterowanie?',
    'faq.answer1': 'Staramy się dostarczyć opcje w ciągu 24 godzin od otrzymania zapytania. W pilnych przypadkach często możemy zorganizować zakwaterowanie tego samego dnia.',
    'faq.question2': 'Które miasta obsługujecie?',
    'faq.answer2': 'Mamy zakwaterowanie w ponad 40 miastach w Szwecji, od Sztokholmu po Göteborg i Malmö, a także w wielu mniejszych miejscowościach. Skontaktuj się z nami, aby dowiedzieć się, czy możemy pomóc w konkretnej lokalizacji.',
    'faq.question3': 'Ile kosztuje wynajęcie zakwaterowania przez Was?',
    ...
    'faq.answer4': 'Tak, wszystkie nasze lokale są w pełni umeblowane i wyposażone we wszystko, czego potrzebują Twoi pracownicy - łóżka, kuchnia, salon, a często także wi-fi i parking.',
    'faq.question5': 'Czy możemy wprowadzać zmiany w rezerwacji po potwierdzeniu?',
    ...
    'why.steps.plan.cta': 'Porozmawiaj o planie → Dzwonimy w 15 min',
    ...
    'why.steps.operations.cta': 'Zapytaj o eksploatację → Pomożemy',
    ...
    'homeowner.hero.title': 'Wynajmij swoje mieszkanie',
    'homeowner.hero.subtitle': 'Masz domek, mieszkanie lub dom, który stoi pusty?',
    'homeowner.hero.incomeRange': '3 000 - 8 000 kr/miesiąc',
    ...
    'homeowner.benefits.title': 'Dlaczego StayOnSite?',
    'homeowner.benefits.subtitle': 'Uzyskaj dodatkowy dochód ze swojego domu z pewnością i prostotą',
    'homeowner.benefits.income.title': 'Gwarantowany dochód',
    'homeowner.benefits.income.description': 'Pewny dochód z wynajmu od 3000-8000 kr/miesiąc',
    'homeowner.benefits.security.title': 'Pewność i bezpieczeństwo',
    'homeowner.benefits.security.description': 'My zajmujemy się wszystkim - najemcy, umowy, komunikacja i płatności',
    'homeowner.benefits.hassle.title': 'Bez zmartwień',
    'homeowner.benefits.hassle.description': 'My zajmujemy się wszystkim - znajdowanie najemcy, umowy, komunikacja i płatności',
    ...
    'homeowner.process.step2.description': 'Umówimy termin bezpłatnej inspekcji i wyceny dochodu',
    'homeowner.process.step3.title': 'Dopasujemy Cię do najemców',
    'homeowner.process.step3.description': 'Znajdziemy odpowiednich najemców spełniających Twoje wymagania i ramy czasowe',
    ...
    'homeowner.testimonials.testimonial1.quote': 'Idealne rozwiązanie! Zarabiamy 5000 kr dodatkowych co miesiąc, a najemcy są zawsze mili i schludni.',
    'homeowner.testimonials.testimonial1.author': 'Anna Eriksson',
    'homeowner.testimonials.testimonial1.location': 'Sztokholm',
    'homeowner.testimonials.testimonial1.income': '+5 000 kr/miesiąc',
    ...
    'homeowner.testimonials.testimonial2.author': 'Lars Andersson',
    'homeowner.testimonials.testimonial2.location': 'Göteborg',
    'homeowner.testimonials.testimonial2.income': '+4 200 kr/miesiąc',
    'homeowner.testimonials.testimonial3.quote': 'Wynajmuję od ponad roku. Nigdy żadnych problemów i zawsze w terminie z płatnościami.',
    'homeowner.testimonials.testimonial3.author': 'Maria Johansson',
    'homeowner.testimonials.testimonial3.location': 'Malmö',
    'homeowner.testimonials.testimonial3.income': '+6 500 kr/miesiąc',
    'homeowner.testimonials.trustIndicator': 'Ponad 200 rodzin już zarabia dodatkowe pieniądze',
    'homeowner.testimonials.trustDescription': 'Dołącz do naszej sieci zadowolonych właścicieli, którzy zarabiają pewny dochód z wynajmu co miesiąc',

    'homeowner.faq.title': 'Najczęściej zadawane pytania dla właścicieli',
    'homeowner.faq.subtitle': 'Uzyskaj odpowiedzi na najczęstsze pytania dotyczące wynajmu najemcom',
    'homeowner.faq.question1': 'Co się stanie, jeśli coś się zepsuje?',
    'homeowner.faq.answer1': 'Jeśli coś się zepsuje, zazwyczaj jest to pokrywane przez ubezpieczenie domowe - Twoje lub najemcy. Oczywiście jesteśmy tu, aby pomóc, jeśli coś się stanie.',
    'homeowner.faq.question2': 'Ile mogę zarobić?',
    'homeowner.faq.answer2': 'Zazwyczaj możesz zarobić od 3 000 do 8 000 kr miesięcznie, w zależności od lokalizacji i rodzaju nieruchomości. Twój rzeczywisty zysk zależy również od np. pożyczek i odsetek. Chętnie udzielimy Ci bezpłatnej konsultacji.',
    'homeowner.faq.question4': 'Co dzieje się między wynajmami?',
    'homeowner.faq.answer4': 'Odzyskujesz pełny dostęp do swojej nieruchomości. Pomagamy również znaleźć nowych najemców tak szybko, jak to możliwe.',
    'homeowner.faq.question5': 'Czy muszę zrobić coś specjalnego z nieruchomością?',
    'homeowner.faq.answer5': 'Nie, ale nieruchomość musi być umeblowana, czysta i w stanie sprawnym.',
    'homeowner.faq.question6': 'Jak otrzymam płatność?',
    'homeowner.faq.answer6': 'Czynsz jest zawsze wypłacany z góry co miesiąc, bezpośrednio na Twoje konto bankowe.',
    ...
    'homeowner.form.disclaimer': 'Rejestrując się, zgadzasz się na kontakt z nami w sprawie wynajmu Twojej nieruchomości.'
  }
};
