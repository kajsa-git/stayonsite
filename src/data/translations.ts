...
export const translations: Record<AvailableLanguages, Record<TranslationKey, string>> = {
  sv: {
    ...
    'homeowner.hero.subtitle': 'Vi hjälper dig hyra ut till hyresgäster - helt utan krångel',
    'homeowner.hero.incomeRange': '3 000 - 8 000 kr/månad per sovrum',
    'homeowner.hero.incomeDescription': 'Säkra hyresintäkter per sovrum från hyresgäster',
