...
export const translations: Record<AvailableLanguages, Record<TranslationKey, string>> = {
  sv: {
    ...
    'services.security.description': '10+ års erfarenhet gör att vi redan har lokala värdar, färdiga rutiner för inflytt och reservplaner när projekten svänger.',
    ...
    'case.subtitle': 'Ett polskt bolag behövde bostäder åt hela montörsteamet inför Säffle.',
  ...
  en: {
    ...
    'case.subtitle': 'A Polish contractor needed to house their entire installer crew ahead of Säffle.',
