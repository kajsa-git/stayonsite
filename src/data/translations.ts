...
export const translations: Record<AvailableLanguages, Record<TranslationKey, string>> = {
  sv: {
    ...
    'references.testimonial1.quote': 'Alltid trevligt och professionellt bemötande. Enkelt och smidigt att hyra, och servicen var riktigt bra. Rekommenderar varmt StayOnSite.',
    'references.testimonial1.author': 'Mats Johansson',
    'references.testimonial1.company': 'Logistik',
    'references.testimonial2.quote': 'Tusen tack Kajsa för ditt fantastiska engagemang, mycket bättre än det jag fått från de stora etablerade företagen!',
    ...
    'homeowner.hero.subtitle': 'Det tar bara två minuter - vi hjälper dig hitta rätt hyresgäst.',
  ...
  en: {
    ...
    'hero.title': 'When you have projects in Sweden - we arrange the accommodation',
    ...
    'references.testimonial1.quote': 'Always pleasant and professional service. Easy and smooth to rent, and the service was really good. Highly recommend StayOnSite.',
    'references.testimonial1.author': 'Mats Johansson',
    'references.testimonial1.company': 'Logistics',
    'references.testimonial2.quote': 'Thank you so much Kajsa for your fantastic commitment, much better than what I got from the large established companies!',
    'references.testimonial2.author': 'Sara Magnusson',
  ...
  pl: {
    ...
    'hero.title': 'Kiedy macie projekty w Szwecji - my organizujemy zakwaterowanie',
    ...
    'references.testimonial1.quote': 'Zawsze miła i profesjonalna obsługa. Łatwe i sprawne wynajmowanie, a usługa była naprawdę dobra. Gorąco polecam StayOnSite.',
    'references.testimonial1.author': 'Mats Johansson',
    'references.testimonial1.company': 'Logistyka',
    'references.testimonial2.quote': 'Wielkie dzięki Kajsa za Twoje fantastyczne zaangażowanie, znacznie lepsze niż to, co otrzymałem od dużych uznanych firm!',
    'references.testimonial2.author': 'Sara Magnusson',
